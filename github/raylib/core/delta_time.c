...
//--------------------------------------------------------------------------------
// eval cc delta_time.c $(pkg-config --libs --cflags raylib) -o delta_time.out
// clang delta_time.c $(pkg-config --libs --cflags raylib) -o delta_time.out
//--------------------------------------------------------------------------------
#include "raylib.h"
...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        // GetFrameTime() returns the time it tool to draw the last frame, in seconds (usually called delta time)
        ...
        // Draw the next above the circles.
